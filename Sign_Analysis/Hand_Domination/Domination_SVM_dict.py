...
if __name__ == '__main__':
    ...
    with open(out_table, 'w') as outfile:
        outfile.write(
            'bvh_source,sign_id,ratio_LH,ratio_RH,domination,ratio_LH_arm,ratio_RH_arm,domination_arm,hand_count,symmetry\n')
        for sign in dictionary_takes:
            ...
            # if not sign['src_pattern'].startswith('predlozky_a_spojky'):
            #     continue
