...
def bidirectional(_datafile, _output_dir, _LSTM_kernels, _epochs):
    """
...
def simple_autoencoder(_datafile, _output_dir, _LSTM_kernels, _epochs):
    """
    Trains LSTM bidirectional network with given parameters.
    :param _datafile: datafile prepared by LSTM_dataprep
    :param _output_dir: model and log is saved there
...
def stacked(_datafile, _output_dir, _LSTM_kernels, _epochs):
    """
    Trains LSTM bidirectional network with given parameters.
    :param _datafile: datafile prepared by LSTM_dataprep
    :param _output_dir: model and log is saved there
    ...
    model = Sequential()
    model.add(LSTM(_LSTM_kernels, activation='relu', input_shape=(time, features), return_sequences=True))
