...
ultimate_dictionary = os.path.join(source_dir, 'ultimate_dictionary2.txt')
...
ret, meta = data_prep.mine_sign_trajectories(bvh_dir, ultimate_dictionary, 10, _sign_id=selected_sign_id, _sign_name=selected_sign_name, _verbose=True)
