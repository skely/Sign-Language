...
prepared_data_file = os.path.join(source_dir, 'prepared_data_ang_30-30.h5')
...
if prep:
    ...
    ret, meta = data_prep.mine_sign_trajectories(bvh_dir, dict_file, _surroundings=surroundings, _sign_id=selected_sign_id, _sign_name=selected_sign_name, _channels=ch_sel_idxs, _verbose=True)
